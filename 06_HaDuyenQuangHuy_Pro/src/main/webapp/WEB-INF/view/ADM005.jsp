...
<body>
	...
	<!-- End vung header -->
	<c:set value="削除しますが、よろしいでしょうか。" var="MSG004"></c:set>
	<!-- Begin vung input-->
			...
			<table border="0" cellpadding="4" cellspacing="0" width="300px">
				<tr>
					...
					<td><input class="btn" type="button"
						onclick="deleteConfirm('${MSG004}', '${userInfo.getUserId()}');"
						value="削除" /></td>
					<td><input class="btn" type="button" value="戻る" onclick="location.href='listUser.do?Status=Back'"/></td>
				</tr>
			</table>
			<!-- End vung button -->
