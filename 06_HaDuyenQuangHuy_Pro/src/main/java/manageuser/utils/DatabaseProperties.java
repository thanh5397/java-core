...
/**
 * Class DatabaseProperties - Xử lý đọc message trong database properties
 *
 * @author Ha Duyen Quang Huy
 */
public class DatabaseProperties {
	private static Map<String, String> mapDBProperties = new HashMap<String, String>();
	static String Link = "\\manageuser\\utils\\properties\\DatabaseProperties.properties";
	static {
		try {
			// táº¡o Ä‘á»‘i tÆ°á»£ng kiá»ƒu Properties
			Properties properties = new Properties();
			// Ä‘á»�c file properties
			properties.load(new InputStreamReader(DatabaseProperties.class.getClassLoader().getResourceAsStream(Link),
					"UTF-8"));
			// lÆ°u cÃ¡c giÃ¡ trá»‹ key trong file properties
			Enumeration<?> enumeration = properties.propertyNames();
			// true náº¿u váº«n cÃ²n pháº§n tá»­, false náº¿u táº¥t cáº£ pháº§n tá»­ Ä‘Ã£
			// Ä‘Æ°á»£c láº¥y ra
