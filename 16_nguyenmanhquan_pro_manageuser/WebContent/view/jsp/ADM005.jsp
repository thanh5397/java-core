					...
					<div style="padding-left:100px;">
						<table border="1" width="70%" class="tbl_input" cellpadding="4" cellspacing="0" style="table-layout: fixed;">
							...
							<tr class="lbl-level-japan" style="display:none">
								...
								<td align="left">
									<c:if test="${userInforEntity.nameLevel != null}">
		...
		<div style="padding-left:100px;">
			<table border="0" cellpadding="4" cellspacing="0" width="300px">
				<tr>
					...
					<td>
						<fmt:setBundle basename="Message" var="messageProperties"/>
						<fmt:message key='MSG004' var="MSG004" bundle="${messageProperties}"/>
						<input class="btn" type="button" value="削除" onclick="showDeleteDialog('${MSG004}', ${userId})"/>
					</td>
					<td>
