...
//	Long deleteByPrimaryKey(int id);
	@Modifying
	@Query(value="INSERT INTO tbl_detail_user_japan (userId,codeLevel,startDate,endDate,total) VALUES (:userId,:codeLevel,:startDate,:endDate,:total)", nativeQuery = true)
	...
	@Modifying
	@Query(value="UPDATE tbl_detail_user_japan d SET d.code_level = ?1, d.start_date = ?2, d.end_date = ?3, d.total = ?4 WHERE d.user_id = ?5", nativeQuery = true)
